            ...
            <div className="mx-auto max-w-[1400px] px-5 md:px-10 py-16 md:py-20 relative w-full">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="font-mono text-sm font-semibold tracking-tight text-gradient">EQUI/CODE</div>
                    ...
                    <div className="flex md:justify-end items-center gap-3">
                        ...
                        <a href="https://www.instagram.com/equi.code" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                            className="flex h-9 w-9 items-center justify-center border border-border text-muted-foreground hover:text-accent hover:border-accent transition-colors">
                            <FaInstagram className="h-4 w-4" />
                        </a>
                        <a href="https://www.linkedin.com/in/ezequiel-riente" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
                            className="flex h-9 w-9 items-center justify-center border border-border text-muted-foreground hover:text-accent hover:border-accent transition-colors">
